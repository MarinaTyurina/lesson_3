text_lesson = '''Все счастливые семьи похожи друг на друга, каждая несчастливая семья несчастлива по-своему.
...
dict_2.sort(key=lambda i: i[1], revers = true)
top_5 = dict_2[0:5]
print('Пять самых повторяющихся слов:', top_5)
